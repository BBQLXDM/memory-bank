...
class ResultMergerTest {
    ...
    class MergeTests {
        ...
        void shouldReturnSingleListAsIs() {
            ...
            assertThat(result.get(0).sourceId()).isEqualTo("1");
        }
        ...
        void shouldKeepHighestVectorScore() {
            ...
            assertThat(result.get(0).vectorScore()).isEqualTo(0.9f);
        }
        ...
        void shouldNormalizeScoresToZeroOneRange() {
            ...
            assertThat(result.get(0).finalScore()).isEqualTo(1.05);
            assertThat(result.get(result.size() - 1).finalScore()).isGreaterThan(0.0);
        ...
        void shouldBoostItemsAppearingInMoreLists() {
            ...
            assertThat(result.get(0).sourceId()).isEqualTo("A");
        }
    }
    ...
    class MergeByRelativeScoreTests {
        ...
        void shouldAccumulateScoresAcrossLists() {
            ...
            assertThat(result.get(0).sourceId()).isEqualTo("A");
            assertThat(result.get(0).finalScore()).isEqualTo(1.0);
        }
    ...
    class VectorScoreDedupTests {
        ...
        void shouldPreferRealVectorScoreOverBm25Zero() {
            ...
            assertThat(result.get(0).vectorScore()).isEqualTo(0.3f);
        }
        ...
        void shouldPreferRealVectorScoreOverBm25ZeroInRsf() {
            ...
            assertThat(result).hasSize(1);
            assertThat(result.get(0).vectorScore()).isEqualTo(0.5f);
        }
    }
    ...
    class WeightedMergeTests {
        ...
        void shouldPenalizeBm25OnlyResults() {
            ...
            assertThat(result.get(0).sourceId()).isEqualTo("A");
            assertThat(result.get(result.size() - 1).sourceId()).isEqualTo("B");
            // B's vectorScore should be 0 (no vector match)
            assertThat(result.get(result.size() - 1).vectorScore()).isEqualTo(0f);
        }
