...
class ConservativeHeuristicEntityResolutionStrategyTest {
    ...
    void conservativeResolverShouldMergeExactAndSupportedSameScriptSafeVariants() {
        ...
        assertThat(resolved.mentions().get(0).metadata())
    ...
    void conservativeResolverShouldStayDeterministicWhenScoresTie() {
        ...
        assertThat(resolved.mentions().get(0).entityKey()).isEqualTo("organization:open ai");
    ...
    void conservativeResolverShouldMergeExplicitParentheticalAliasEvidence() {
        ...
        assertThat(resolved.mentions().get(0).entityKey()).isEqualTo("organization:openai");
        assertThat(resolved.mentions().get(0).metadata())
    ...
    void conservativeResolverShouldUseUserDictionaryOnlyWhenEnabled() {
        ...
        assertThat(disabled.mentions().get(0).entityKey()).isEqualTo("organization:openai china");
        assertThat(enabled.mentions().get(0).entityKey()).isEqualTo("organization:openai");
        assertThat(enabled.mentions().get(0).metadata())
    ...
    void explicitAliasEvidenceMustNotCrossTypeProbeReservedSpecialEntities() {
        ...
        assertThat(resolved.mentions().get(0).entityKey()).isEqualTo("person:客户");
        assertThat(resolved.resolutionDiagnostics().candidateRejectCounts()).isEmpty();
    ...
    void conservativeResolverShouldPersistResolverSynthesizedAliasEvidenceForSafeVariantMerges() {
        ...
        assertThat(
                        ((Number) resolved.entities().get(0).metadata().get("aliasEvidenceCount"))
                                .intValue())
                .isEqualTo(1);
        assertThat((List<String>) resolved.entities().get(0).metadata().get("aliasClasses"))
                .containsExactly("spacing");
        assertThat((List<String>) resolved.entities().get(0).metadata().get("topAliases"))
    ...
    void conservativeResolverShouldMergeUniqueHistoricalAliasHits() {
        ...
        assertThat(resolved.mentions().get(0).entityKey()).isEqualTo("organization:google");
        assertThat(resolved.mentions().get(0).metadata())
