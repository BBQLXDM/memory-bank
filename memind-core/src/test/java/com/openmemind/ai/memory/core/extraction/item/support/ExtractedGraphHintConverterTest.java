...
class ExtractedGraphHintConverterTest {
    ...
    void convertsEntitiesAndCausalRelations() {
        ...
        assertThat(hints.entities().get(0).name()).isEqualTo("src/payment/calc.ts");
        assertThat(hints.entities().get(0).salience()).isEqualTo(1.0f);
        assertThat(hints.causalRelations()).hasSize(1);
        assertThat(hints.causalRelations().get(0).relationType()).isEqualTo("enabled_by");
        assertThat(hints.causalRelations().get(0).strength()).isEqualTo(0.0f);
    }
