...
class LlmItemExtractionStrategyTest {
    ...
    void toFactEntriesShouldPreserveRawEntityTypeLabels() {
        ...
        assertThat(entries.get(0).graphHints().entities())
    ...
    void toFactEntriesShouldParseAliasObservationsIntoGraphHints() {
        ...
        assertThat(entries.get(0).graphHints().entities().get(0).aliasObservations())
                .singleElement()
                .extracting(
    ...
    void extractShouldRenderCategoryContextFromConfigAllowedCategories() {
        ...
        assertThat(client.allMessages().get(0).get(0).content()).contains("[USER Scope]");
        assertThat(client.allMessages().get(0).get(0).content()).doesNotContain("[AGENT Scope]");
    }
            ...
            StepVerifier.create(
                    ...
                    .assertNext(
                            entries -> {
                                ...
                                assertThat(entries.get(0).occurredStart())
                                        .isEqualTo(Instant.parse("2026-04-06T00:00:00Z"));
                                assertThat(entries.get(0).occurredEnd())
                                        .isEqualTo(Instant.parse("2026-04-13T00:00:00Z"));
                                assertThat(entries.get(0).timeGranularity()).isEqualTo("week");
                                assertThat(entries.get(0).occurredAt()).isNull();
