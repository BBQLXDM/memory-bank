...
class TextChunkerTest {
    ...
    class ChunkByLineTests {
        ...
        void shouldReturnSingleChunkForShortText() {
            ...
            assertThat(segments.get(0).content()).isEqualTo("Short text");
        }
        ...
        void shouldSkipBlankLines() {
            ...
            assertThat(segments).hasSize(1);
            assertThat(segments.get(0).content()).contains("First line");
            assertThat(segments.get(0).content()).contains("Second line");
        }
    }
    ...
    class BoundaryTests {
        ...
        void shouldRecordLineBoundary() {
            ...
            assertThat(segments.get(0).boundary()).isInstanceOf(CharBoundary.class);
        }
    }
}
