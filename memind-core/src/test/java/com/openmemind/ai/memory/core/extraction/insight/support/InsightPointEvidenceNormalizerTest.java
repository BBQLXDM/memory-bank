...
class InsightPointEvidenceNormalizerTest {
    ...
    void normalizeLeafPointsShouldSortDistinctSourceItemIdsAndClearPointRefs() {
        ...
        assertThat(normalized.get(0).sourceItemIds()).containsExactly("1", "2", "3");
        assertThat(normalized.get(0).sourcePointRefs()).isEmpty();
    }
    ...
    void normalizeBranchPointsShouldKeepValidatedLeafRefsOnly() {
        ...
        assertThat(normalized.get(0).sourceItemIds()).isEmpty();
        assertThat(normalized.get(0).sourcePointRefs())
    ...
    void normalizeRootPointsShouldDropDanglingBranchRefs() {
        ...
        assertThat(normalized.get(0).content()).isEqualTo("Root point");
        assertThat(normalized.get(0).sourcePointRefs()).isEmpty();
    }
