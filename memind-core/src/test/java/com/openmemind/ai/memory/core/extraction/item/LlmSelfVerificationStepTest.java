            ...
            StepVerifier.create(
                    ...
                    .assertNext(
                            result -> {
                                ...
                                assertThat(result.get(0).rawDataId()).isEqualTo(RAW_DATA_ID);
            ...
            StepVerifier.create(step.verify(ORIGINAL_TEXT, List.of(), RAW_DATA_ID))
                    .assertNext(
                            result -> {
                                ...
                                assertThat(result.get(0).confidence()).isEqualTo(1.0f);
                                assertThat(result.get(0).insightTypes()).isEmpty();
                            })
                    .verifyComplete();
        }
        ...
        void shouldKeepOccurredAtNullWhenTheReviewResultHasNoSemanticTime() {
            ...
            StepVerifier.create(
                    ...
                    .assertNext(
                            result -> {
                                assertThat(result).hasSize(1);
                                assertThat(result.get(0).occurredAt()).isNull();
                            })
                    .verifyComplete();
        }
        ...
        void shouldPreserveObservedAtFromTheSourceSegment() {
            ...
            StepVerifier.create(
                    ...
                    .assertNext(
                            result -> {
                                assertThat(result).hasSize(1);
                                assertThat(result.get(0).observedAt()).isEqualTo(observedAt);
                            })
                    .verifyComplete();
        }
            ...
            try {
                ...
                StepVerifier.create(
                        ...
                        .assertNext(
                                result -> {
                                    assertThat(result).hasSize(1);
                                    assertThat(result.get(0).occurredStart())
                                            .isEqualTo(Instant.parse("2026-04-06T00:00:00Z"));
                                    assertThat(result.get(0).occurredEnd())
                                            .isEqualTo(Instant.parse("2026-04-13T00:00:00Z"));
                                    assertThat(result.get(0).timeGranularity()).isEqualTo("week");
                                    assertThat(result.get(0).occurredAt()).isNull();
